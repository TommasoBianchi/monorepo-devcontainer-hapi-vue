/*
Adapted from https://github.com/JoshuaKGoldberg/template-typescript-node-package/blob/main/.eslintrc.cjs
...
module.exports = {
  ...
  rules: {
    ...
    "no-unused-vars": ["error", { argsIgnorePattern: "(server|options|request|h)" }],
